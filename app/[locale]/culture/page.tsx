             ...
             <div className="w-full lg:w-1/3">
                <div className="grid grid-cols-2 gap-4">
                   <div className="bg-white p-6 rounded-[2rem] border border-foreground/5 shadow-sm text-center">
                      ...
                      <span className="text-[10px] font-black uppercase tracking-widest text-foreground/40 block mb-1">{t("ritual_label")}</span>
                      <span className="text-sm font-bold text-foreground">{t("ritual_name")}</span>
                   </div>
                   <div className="bg-white p-6 rounded-[2rem] border border-foreground/5 shadow-sm text-center translate-y-8">
                      ...
                      <span className="text-[10px] font-black uppercase tracking-widest text-foreground/40 block mb-1">{t("kinship_label")}</span>
                      <span className="text-sm font-bold text-foreground">{t("kinship_name")}</span>
                   </div>
                </div>
             </div>
          </div>
