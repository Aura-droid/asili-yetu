    ...
    <section className="py-24 bg-foreground rounded-[4rem] mx-4 md:mx-12 overflow-hidden text-background border border-white/5 shadow-[0_0_50px_rgba(0,0,0,0.5)]">
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col md:flex-row items-end justify-between mb-20 gap-8">
           <div>
              <span className="text-[10px] font-black uppercase tracking-[0.4em] text-amber-500 mb-4 block">Cultural Masterpieces</span>
              <h2 className="text-5xl md:text-7xl font-black italic uppercase tracking-tighter leading-[0.9]">
                 The Soul of <br/> <span className="text-amber-500 italic">Heritage</span>
              </h2>
           </div>
           <div className="flex gap-2">
              {stories.map((_, i) => (
                <div 
                  key={i} 
                  className={`h-1.5 transition-all duration-1000 rounded-full ${index === i ? 'w-16 bg-amber-500' : 'w-2 bg-white/10'}`} 
                />
              ))}
           </div>
        </div>
            ...
            >
               <div className="w-full h-[500px] rounded-[3.5rem] overflow-hidden relative border border-white/10 flex-shrink-0 group">
                  ...
                  <div className="absolute top-10 left-10">
                     <span className="bg-black/60 backdrop-blur-md px-6 py-2 rounded-full border border-white/10 text-[10px] font-black text-amber-500 uppercase tracking-[0.3em]">
               ...
               <div className="flex flex-col justify-center">
                  <div className="flex items-center gap-3 mb-6">
                     ...
                     <span className="text-xs font-black uppercase tracking-[0.3em] text-amber-500">{story.category}</span>
                  </div>
                  ...
                  <p className="text-background/40 text-xl font-medium italic leading-relaxed mb-12 border-l-2 border-amber-500/30 pl-8">
                    "{story.description}"
                  </p>
                  <Link href="/culture" className="inline-flex items-center gap-4 text-sm font-black uppercase tracking-[0.3em] text-white hover:text-amber-500 transition-all group">
