    ...
    <div className="fixed bottom-8 left-8 z-[100] flex items-center gap-4">
      ...
      <div className="relative group">
        ...
        <motion.div
          ...
          className="absolute inset-0 bg-primary/40 rounded-full z-0"
        />
        ...
        <motion.a
          ...
          className="relative z-10 w-14 h-14 bg-foreground text-primary rounded-full flex items-center justify-center shadow-[0_10px_30px_rgba(0,0,0,0.3)] border border-primary/20 transition-all group-hover:border-primary/50 group-hover:shadow-[0_15px_40px_rgba(250,204,21,0.3)]"
        >
