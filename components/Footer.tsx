    ...
    <footer className="bg-background border-t border-foreground/10 pt-20 pb-10 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-16">
          ...
          <div>
            <h4 className="text-foreground font-black uppercase tracking-widest text-xs mb-6">Expeditions</h4>
          ...
          <div>
            <h4 className="text-foreground font-black uppercase tracking-widest text-xs mb-6">Contact Base</h4>
          ...
          <div className="bg-foreground/5 p-6 rounded-3xl border border-foreground/10 flex flex-col justify-center items-start">
             ...
             <a 
                ...
                className="w-full bg-[#25D366] hover:bg-[#128C7E] text-white font-bold py-3 px-4 rounded-xl flex items-center justify-center gap-2 transition-all hover:scale-105 active:scale-95 shadow-lg shadow-[#25D366]/20"
             >
        ...
        <div className="border-t border-foreground/10 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-foreground/40 text-xs font-bold tracking-widest uppercase">
            &copy; {new Date().getFullYear()} Asili Yetu Safaris and Tours. All Rights Reserved.
          </p>
